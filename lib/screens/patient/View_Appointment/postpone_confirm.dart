...
class PostPoneConfirm extends StatefulWidget {
  ...
  @override
  _PostPoneConfirmState createState() => _PostPoneConfirmState();
}

class _PostPoneConfirmState extends State<PostPoneConfirm> {

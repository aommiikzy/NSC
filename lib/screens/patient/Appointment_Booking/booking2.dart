...
import 'package:mu_dent/screens/patient/Appointment_Booking/booking3.dart';
...
class DateBooking extends StatefulWidget {
  // DateBooking(String appointmentType, String dentistName);

  final String appointmentType;
  final String dentistName;
  DateBooking({this.appointmentType, this.dentistName});
...
class _DateBookingState extends State<DateBooking> {
  ...
  Future<void> _getAppointmentDays() async {
    ...
    await appointmentCollection
      ...
      querysnapshot.docs.forEach((result) {
        ...
        // String dateForm = DateFormat.yMMMd().format(b);
        var dateToTimeStamp =
            DateTime.fromMillisecondsSinceEpoch(a.millisecondsSinceEpoch);
  ...
  void setCalendar() async {
    ...
    storedDay.forEach((key, value) {
      ...
      if (value == 10) {
        _markedDateMap.add(
            new DateTime(int.parse(splitVal[2]), int.parse(splitVal[1]),
                int.parse(splitVal[0])),
            new Event(
                date: new DateTime(int.parse(splitVal[2]),
                    int.parse(splitVal[1]), int.parse(splitVal[0])),
              ...
              Container(
                ...
                child: DateTimeFormField(
                  validator: ((val) => val.isAfter(DateTime(_currentDate.year,
                      ...
                      ? null
                      : "Appointment must be made 2 days in advance"),
